...
class build_data():
    def __init__(self,fname):
        ...
        self.dataset_set_bio_tags, self.dataset_set_ec_tags = utils.getEntitiesFromDocuments(dataset_documents)  ## get BIO tags. 'B-Peop', 'I-Peop', 'O'
        self.dataset_set_relations = utils.getRelationsFromDocuments(dataset_documents) ## get relations. 'Kill'
        self.dataset_set_bio_relation_ners, self.dataset_set_ec_relation_ners = utils.getRelationNersFromDocuments(dataset_documents) ## get relation-ner set. for example 'Kill__B-Peop', 'Kill__I-Peop'
        ...
        parsers.preprocess(self.train_id_docs, self.wordindices, self.dataset_set_characters,
                           ...
                           self.dataset_set_bio_relation_ners, self.dataset_set_ec_relation_ners)
